...
def main():
    message = (
        "Lenovo found out a bug in there storage Platform."
        "They wants to know why the bug is only for banking domain."
        "Please contact the technical development team."
    )
    try:
